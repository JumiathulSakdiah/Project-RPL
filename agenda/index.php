...
<head>
    ...
    <title>Agenda - Daring Reminder</title>
</head>
<body class="text-white relative overflow-hidden">
                ...
                <div class="bg-gray-normal p-4 px-6 rounded-xl space-y-6 w-auto h-auto ">
                    ...
                    <div class="flex flex-row pt-2 justify-between">
                        <div class="flex flex-row space-x-4 ">
                            <div class="w-56">
                                <select name="cars" id="cars" class="cursor-pointer bg-gray-lightest w-full rounded-xl border-none p-2 pl-4 text-xl">
                                    <option value="1">Semua Agenda</option>
                            ...
                            <div class="w-128">
                                <select name="cars" id="cars" class="truncate cursor-pointer bg-gray-lightest w-full rounded-xl border-none p-2 pl-4 pr-10 text-xl">
                                    <option value="1">Semua Subjek</option>
                    ...
                    <div class="grid grid-flow-row grid-cols-2 gap-6 pt-2 pb-4">
                        <div class="hover:opacity-60 cursor-pointer bg-gradient-to-br from-tugas-primary to-tugas-secondary p-5 rounded-2xl shadow-lg h-auto w-full flex-none space-y-2">
                            <h1 class=" text-md h-8 font-bold line-clamp-2">
                                <span>
                                    Tugas
                                </span>
                                ...
                                <span class=" text-md h-8 font-bold">
                                    Rekayasa perangkat Lunak
                                </span>
                            </h1>
                            
                            <h2 class=" text-2xl h-24 font-extrabold line-clamp-3">
                                Tugas Mata Kuliah Rekayasa Perangkat Lunak
                            </h2>
                            <div class="flex justify-between">
                                <h2 class=" text-md h-4 font-bold truncate">
                                    Senin, 12 April 2021
                                </h2>
                                <h2 class=" text-md h-4 font-bold truncate">
                                    23:59
                        ...
                        <div class="hover:opacity-60 cursor-pointer bg-gradient-to-br from-ujian-primary to-ujian-secondary p-5 rounded-2xl shadow-lg h-auto w-full flex-none space-y-2">
                            <h1 class=" text-md h-8 font-bold line-clamp-2">
                                <span>
                                    Ujian
                                </span>
                            ...
                            <h2 class=" text-2xl h-24 font-extrabold line-clamp-3">
                                Ujian Mata Kuliah Rekayasa Perangkat Lunak
                            </h2>
                            <div class="flex justify-between">
                                <h2 class=" text-md h-4 font-bold truncate">
                                    Senin, 12 April 2021
                        ...
                        <div class="hover:opacity-60 cursor-pointer bg-gradient-to-br from-reminder-primary to-reminder-secondary p-5 rounded-2xl shadow-lg h-auto w-full flex-none space-y-2">
                            <h1 class=" text-md h-8 font-bold line-clamp-2">
                                <span>
                                    Reminder
                                </span>
                        ...
                        <div id="add-agenda" class="hover:opacity-40 cursor-pointer bg-gray-light p-5 rounded-2xl opacity-60 h-50 w-full flex-none space-x-3 flex justify-center items-center " >
                            ...
                            <h1 class=" text-left text-3xl font-extrabold truncate">Tambah Agenda</h2>
                        </div>
    ...
    <div id="form-agenda" class="scale-110 absolute flex justify-center items-center -top-full left-0 w-full h-full z-40  backdrop-filter  transform  transition duration-500 ease-in-out">
