...
<head>
    ...
    <title>Catatan - Daring Reminder</title>
</head>
<body class="text-white relative overflow-hidden">
            ...
            <div class="flex flex-auto flex-col bg-gray-dark p-8 space-y-6 overflow-y-auto no-scrollbar">
                <div class="bg-gray-normal p-4 px-6 rounded-xl space-y-6 w-auto h-auto ">
                    ...
                    <div class="grid grid-flow-row grid-cols-2 gap-6 pt-2 pb-4">
                        <div class="hover:opacity-60 cursor-pointer bg-gradient-to-br from-catatan-primary to-catatan-secondary p-5 rounded-2xl shadow-lg h-auto w-full flex-none space-y-2">
                            ...
                            <h2 class=" text-2xl h-24 font-extrabold line-clamp-3">
                                Catatan Rekayasa Perangkat Lunak Minggu Ke-1
                            </h2>
                        ...
                        <div id="add-agenda" class="hover:opacity-40 cursor-pointer bg-gray-light p-5 rounded-2xl opacity-60 h-50 w-full flex-none space-x-3 flex justify-center items-center " >
                            ...
                            <h1 class=" text-left text-3xl font-extrabold truncate">Tambah Catatan</h2>
                        </div>
    ...
    <div id="form-agenda" class="scale-110  absolute flex justify-center items-center -top-full left-0 w-full h-full z-40  backdrop-filter  transform  transition duration-500 ease-in-out">
        ...
        <div  class="bg-gray-light rounded-3xl  w-2/3 flex flex-col p-8 ">
            ...
            <form action="#" class="space-y-16">
                <div class="flex">
                    <div class="flex flex-row space-x-3 w-1/2">
                        <div id="form-color" class="bg-gradient-to-r from-catatan-primary to-catatan-secondary  w-8 rounded-full"></div>
                        <textarea name="judul" id="" cols="30" rows="2" class="bg-gray-light border-0 focus:ring-0 text-3xl w-full overflow-hidden placeholder-italic font-bold"  placeholder="Tambah nama catatanmu disini..."></textarea>
                    </div>
                    <div class="flex flex-row space-x-4 items-center  w-1/2">
                        <div class=" w-1/4">
                ...
                <div class="space-y-4">
                    ...
                    <textarea name="judul" id="" cols="30" rows="12" class="bg-gray-normal rounded-2xl border-0 focus:ring-0 text-3xl w-full overflow-hidden placeholder-italic font-bold"  placeholder="Tambah nama catatanmu disini..."></textarea>
                    
                    <div class="w-full flex justify-end">
                        <input type="submit" value="Tambah Catatan" class="flex flex-row cursor-pointer bg-gradient-to-r from-primary to-gray-lightest shadow-lg hover:opacity-60 py-4 px-6 rounded-2xl font-bold text-xl">
                    </div>
                </div>
            </form>
